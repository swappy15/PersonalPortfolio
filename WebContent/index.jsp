...
-->
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-sm navbar-light">
        <div class="container">
            <a class="navbar-brand" href="index.html"><i class='uil uil-user'></i> Swapnil</a>
                        ...
                        <div class="custom-btn-group mt-4">
                          <form action="UploadResume" method="post">
                           <input type="hidden" name="check" value="download">
                            <button class="btn mr-lg-2 custom-btn" class='uil uil-file-alt'>Download Resume</button>
                          </form>
                  ...
                  <h2 class="mb-4 mobile-mt-2">Educations</h2>
                    ...
                    <div class="timeline">
                        ...
                        <div class="timeline-wrapper">
                             ...
                             <div class="timeline-info">
                                  <h3><span><%=ep.getTitle()%></span><small><%=ep.getSubtitle()%></small></h3>
        ...
        <div class="row">
          ...
          <div class="col-lg-5 mr-lg-5 col-12">
            <div class="google-map w-100">
              "<iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d15128.777712914516!2d73.9175673!3d18.5652712!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bc2c1268ac5f317%3A0xeceb4506f0e3c3f9!2sSEED%20Infotech!5e0!3m2!1sen!2sin!4v1681147432086!5m2!1sen!2sin" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>></iframe>
            </div>
...
<!-- KAAM -->
    ...
    <section>
        ...
        web page-->
    <div data-pym-src=
"https://www.jdoodle.com/embed/v0/5Agk">
    </div>
